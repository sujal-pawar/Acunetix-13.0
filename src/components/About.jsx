  ...
  return (
    <section ref={ref} id="about" className="about-section min-h-screen relative overflow-hidden">
      ...
      <div className="about-content">
        <h2 className="about-title text-8xl  md:text-8xl lg:text-9xl font-black uppercase tracking-wider text-white" style={{ fontFamily: "'VerminVibes', 'Orbitron', sans-serif" }}>About Us</h2>
