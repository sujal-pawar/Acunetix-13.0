  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      ...
      <motion.div
        ...
        style={{ ...style, background: 'linear-gradient(to right, #00ffc8, #00b89c)' }}
      />
      <motion.div
        className="absolute inset-0 rounded-2xl opacity-0 mix-blend-overlay group-hover/card:opacity-100"
        style={style}
      >
        <p className="absolute inset-0 text-xs wrap-break-word whitespace-pre-wrap text-white font-mono font-bold transition duration-500">
          {randomString}
        </p>
      </motion.div>
    </div>
