...
const scheduleEvents = [
    { id: 1, name: "GAMESTROM", location: "B-508", time: "10:00 AM", align: "left" },
    { id: 2, name: "ESCAPE ROOM", location: "B-409 AND B-411", time: "1:00 PM", align: "right" },
    { id: 3, name: "CTRL ALT ELITE", location: "Rooftop Strategy", time: "5:00 PM", align: "left" }
];
...
const SchedulePage = () => {
    ...
    return (
        <div className="schedule-page" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <h2 className="schedule-subtitle" style={{ zIndex: 1, position: 'relative' }}>(27th March)</h2>
